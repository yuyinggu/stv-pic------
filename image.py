...
huangli_path = "\\\\vdisk.chineseradio.local\\it\\Jobs\\Constellation\\Photo\\黃曆_Background-01.jpg" #黄历背景图片路径
huangli_path2 = "\\\\vdisk.chineseradio.local\\it\\Jobs\\Constellation\\Photo\\黃曆_Background-02.jpg" #黄历背景图片路径
...
record_dir = "\\\\vdisk.chineseradio.local\\VideoWork\\OtherVideos\\STPlayer\\Source\\"+ tomorrow_list[0]+"\\"+ tomorrow_list[1] +"\\"+ tomorrow_list[2] +"\\"+"Constellation/" + tomorrow_list[1] +tomorrow_list[2] + ".txt" #txt文件路径
txt_exist = False
